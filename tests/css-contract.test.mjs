...
const requiredContracts = [
  ...
  '.nds-search-filter__input-shell',
  ...
  '.nds-search-filter__result',
  '.nds-search-filter__identity',
  '.nds-search-filter__avatar',
  '.nds-search-filter__copy',
  '.nds-search-filter__title',
  '.nds-search-filter__owner',
  '.nds-search-filter__type',
  '.nds-form',
  '.nds-form__section',
  '.nds-form__legend',
  '.nds-form__grid',
  ...
  '.nds-settings__row',
  '.nds-confirmation',
  '.nds-confirmation-target',
  '.nds-confirmation-target__mark',
  '.nds-confirmation-target__content',
  '.nds-confirmation-target__meta',
  '.nds-confirmation-target__action',
